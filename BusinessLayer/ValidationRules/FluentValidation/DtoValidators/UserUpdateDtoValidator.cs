...
namespace BusinessLayer.ValidationRules.FluentValidation.DtoValidators
{
    public class UserUpdateDtoValidator:AbstractValidator<UserUpdateDto>
    {
        ...
        public UserUpdateDtoValidator()
        {
            ...
            RuleFor(x => x.UserName).NotEmpty().WithMessage("Kullanıcı Adı" + NotEmptyMessage).MaximumLength(50).WithMessage("Kullanıcı Adı alanı 50 karakterden büyük olmamalıdır.").MinimumLength(3).WithMessage("Kullanıcı Adı alanı 3 karakterden küçük olmamalıdır.");
            ...
            RuleFor(x => x.PhoneNumber).NotEmpty().WithMessage("Telefon Numarası" + NotEmptyMessage).MaximumLength(14).WithMessage("Telefon Numarası alanı 14 karakterden büyük olmamalıdır.").MinimumLength(12).WithMessage("Telefon Numarası alanı 12 karakterden küçük olmamalıdır.");
